...
$str->edit_link='hal=tambah_event';
$str->penguji_link='hal=daftar_penguji';
$str->partisipan_link='hal=daftar_atlet';
$str->maxresult=10;
$str->hal=(int)$_GET['n'];
	...
	while($h=mysql_fetch_array($sql)){
		...
		$str->daftar.='
		  <tr>
			...
			<td valign="top" align="center">'.$h['tanggal'].'</td>
			<td align="center" valign="top"><a href="?'.$str->penguji_link.'&amp;id='.$h['id_event'].'&amp;action=penguji">Penguji</a> </td>
			<td align="center" valign="top"><a href="?'.$str->partisipan_link.'&amp;id='.$h['id_event'].'&amp;action=partisipan">Partisipan</a></td>
			<td align="center" valign="top"><a href="?'.$str->edit_link.'&amp;id='.$h['id_event'].'&amp;action=delete"><img src="images/delete.png"></a> <a href="?'.$str->edit_link.'&amp;id='.$h['id_event'].'&amp;action=edit"><img src="images/edit.png"></a></td>
		  </tr>
		';
	}
}
...
?>
		...
		<div style="font-size:18px;padding:10px 0 10px 0 ">DATA EVENT</div>
		<div align="right"><a href="?hal=tambah_event&amp;action=new">Tambah Data</a></div><br>
		<table width="100%" border="0" cellspacing="4" cellpadding="0" class="tabel_reg">
		  <tr>
            ...
            <td align="center" width="80">Tanggal</td>
            <td align="center" width="80">Penguji</td>
             <td align="center" width="80">Partisipan</td>

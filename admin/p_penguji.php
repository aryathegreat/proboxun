...
$str->nav_link='hal=data_penguji';
$str->edit_link='hal=tambah_penguji';
$str->maxresult=10;
$str->hal=(int)$_GET['n'];
$qq="select * from tb_user";
...
$q="select * from tb_user where username != 'admin' limit ".$str->hal.",".$str->maxresult;//gunakan mysql syntak tidak sama dengan untuk mencegah data admin tampil d tabel 
$sql=mysql_query($q);
	...
	while($h=mysql_fetch_array($sql)){
		...
		$str->daftar.='
		  <tr>
			...
			<td valign="top" align="center">'.$h['alamat'].'</td>
			<td valign="top" align="center">'.$h['jenis_kelamin'].'</td>
			<td valign="top" align="center">'.$h['satlat'].'</td>
			<td valign="top" align="center">'.$h['username'].'</td>
			<td align="center" valign="top"><a href="?'.$str->edit_link.'&amp;id='.$h['id_admin'].'&amp;action=delete"><img src="images/delete.png"></a> </td>
		  </tr>
		';
	}
}
...
?>
		...
		<div style="font-size:18px;padding:10px 0 10px 0 ">DATA PENGUJI</div>
		<div align="right"><a href="?hal=tambah_penguji&amp;action=baru">Tambah Data</a></div><br>
		<table width="100%" border="0" cellspacing="4" cellpadding="0" class="tabel_reg">
		  <tr>
			<td align="center" width="40">No.</td>
			<td align="center">Nama Penguji</td>
			<td align="center" width="300">Alamat</td>

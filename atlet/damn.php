...
for($i=1;$i<=2;$i++){
	...
	if($_GET['action']=='histori' and !empty($_GET['id'])){	
	...
	FROM tb_partatlet
	JOIN tb_alternatif ON tb_partatlet.id_alternatif = tb_alternatif.id_alternatif WHERE CONCAT (tb_partatlet.id_alternatif) = 8 ");//bener gak ni ?
...
$qq="SELECT 
	...
	tb_alternatif.jenis_kelamin 
	FROM tb_partatlet
	JOIN tb_alternatif ON tb_partatlet.id_alternatif = tb_alternatif.id_alternatif WHERE CONCAT (tb_partatlet.id_alternatif) = 8 ";
...
JOIN tb_histori ON tb_histori.id_partatlet = tb_partatlet.id_partatlet WHERE CONCAT (tb_partatlet.id_alternatif) = 8 limit ".$str->hal.",".$str->maxresult;
$sql=mysql_query($q);
      ...
      <div style="overflow:auto; max-height:250px; margin:10px 0 20px 0;" >
		...
		<table width="100%" border="0" cellspacing="4" cellpadding="0" class="tabel_reg">
		  <tr>
			...
			<td align="center" width="180">Nama Event</td>
			<td align="center" width="80">Tahun</td>
			<td align="center" width="80">Kelas</td>
            
			<td align="center" width="40">Rangking</td>
            <td align="center" width="180">Waktu</td>
		  </tr>
		  <?php echo $str->daftar;?>
		</table>
